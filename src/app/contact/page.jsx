          ...
          >
            <div>
              ...
              <p className="text-gray-300 text-base font-light mt-4 leading-relaxed">
                Whether you are planning a destination wedding at Utsav Vatika, a flagship corporate keynote, or an exhibition showcase, our production team is ready.
              </p>
            </div>
            ...
            <div className="space-y-6 pt-4 border-t border-white/10 text-sm">
              <div className="flex items-start gap-4 p-5 rounded-2xl bg-white/[0.02] border border-white/10">
                ...
                <div>
                  <h4 className="font-bold font-heading text-white">Surat Headquarters</h4>
            ...
            {submitted ? (
              <div className="py-16 text-center space-y-4">
                ...
                <p className="text-gray-300 text-sm max-w-md mx-auto">
                  Thank you for contacting {siteConfig.brandName}. Our event directors will get in touch with you within 24 hours.
                </p>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  >
                    <option value="Luxury Wedding">Destination Wedding / Sangeet</option>
                    <option value="Brand Activation">Brand Activation / Corporate Summit</option>
                    <option value="Exhibition">Exhibition / Trade Show Fabrication</option>
                    <option value="Fashion Show">Fashion Runway / Stage Production</option>
                  </select>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    rows={4}
                    required
                    placeholder="Tell us about expected guest count, target dates, venue, and design vision..."
